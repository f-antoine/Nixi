...
{
    /// <summary>
    /// Base attribute to represent a dependency injection in a Component field of a class instance derived from MonoBehaviourInjectable with a Nixi approach
    /// </summary>
    [AttributeUsage(AttributeTargets.Field | AttributeTargets.Property, AllowMultiple = false)]
    public abstract class NixInjectComponentBaseAttribute : Attribute
    {
        /// <summary>
        /// Find the unique component which exactly matches criteria of a derived attribute from NixInjectComponentBaseAttribute using the Unity dependency injection method
        /// </summary>
